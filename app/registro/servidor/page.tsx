...
export default async function ServidorRegistrationPage() {
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col items-center gap-6 mb-8">
            ...
            <div className="text-center">
              <h1 className="text-3xl font-bold mb-2">Registro de Servidores</h1>
              <p className="text-muted-foreground">Completa el formulario para inscribirte como servidor del retiro</p>
            </div>
          </div>

          <div className="mb-6 p-6 bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg">
            <p className="text-lg font-semibold mb-3">Valor del servicio: ${Number(settings.costo_servidor).toLocaleString("es-CO")}</p>
