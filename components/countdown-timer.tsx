...
const TARGET_DATE_MS = Date.UTC(2026, 3, 10, 21, 0, 0) // 2026-04-10 16:00 Colombia (UTC-5)

function getRemainingTime(nowMs: number): CountdownParts {
  const totalMs = Math.max(TARGET_DATE_MS - nowMs, 0)
